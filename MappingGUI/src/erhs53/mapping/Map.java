...
//					   AV1 = new Road("AV1", 100, true, true),
//					   AV2 = new Road("AV2", 80),
//					   AV3 = new Road("AV3", 60),
//					   AV4 = new Road("AV4", 70),
//					   AV5 = new Road("AV5", 50),
...
//					   AH3 = new Road("AH3", 110, true, false),
//					   AH4 = new Road("AH4", 265, true, false),
//					   AH5 = new Road("AH5", 150),
//					   AH7 = new Road("AH7", 120),
//					   AH8 = new Road("AH8", 310),
//					   AC0 = new Road("AC0", 85, true, true),
//					   AC1 = new Road("AC1", 125, true, true),
//					   AC2 = new Road("AC2", 80, true, false),
//					  AC3B = new Road("AC3B", 75, true, false),
//							 
//					   BV0 = new Road("BV0", 50),
//					   BV1 = new Road("BV1", 50),
//					   //BV2 = new Road("BV2", 50),
//					   BV3 = new Road("BV3", 50),
//					   BV4 = new Road("BV4", 90),
//					   BV5 = new Road("BV5", 50, true, false),
//					   BV6 = new Road("BV6", 90),
//					   BV7 = new Road("BV7", 75),
//					   BV8 = new Road("BV8", 20, true, false),
//					   BV9 = new Road("BV9", 75),
//					   BV10 = new Road("BV10", 75),
//					   BV11 = new Road("BV11", 75, true, false),
...
//					   BH6 = new Road("BH6", 65, true , false),
//					   BH7 = new Road("BH7", 110, true, false),
//					   BH8 = new Road("BH8", 105),
//					   BH9 = new Road("BH9", 110),
//					   BH10 = new Road("BH10", 150),
//					   BH11 = new Road("BH11", 180),
//					   BH12 = new Road("BH12", 165),
//					   BC0 = new Road("BC0", 165, true, true), //measure actual dist
//					   BC1 = new Road("BC1", 60, true, true), //^
//							 
//					   CV0 = new Road("CV0", 50),
//					   CV1 = new Road("CV1", 50),
...
//					   CV5 = new Road("CV5", 75, true, false),
//					   CV7 = new Road("CV7", 75),
//					   CV8 = new Road("CV8", 75),
//					   CV9 = new Road("CV9", 75),
//					   CV10 = new Road("CV10", 75, true, false),
...
//		CV10.setActions(a(GS, CV2));
		R0.setActions(a(TL, R2));
		R1.setActions(a(TR, R2));
		R2.setActions(a(TR, R4));
		R4.setActions(a(TR, R5));
		R5.setActions(a(TL, R6));
		R6.setActions(a(PL, G1));
//				
		Goal.COST = generateCosts(G1);
